 ...
 */
public class AgentHillClimber extends AbstractPlayer {

	SimpleStateHeuristic ssh;
    public AgentHillClimber(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
    ...
    public Types.ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
				...
				&& elapsedTimer.remainingTimeMillis() > worstTime)
		{
			...
			stateChoosedQueue.add(currentNode);
			iterLimit++;
			
			if(iterLimit >= limit)
			{
				currentNode = nodeComparison(stateChoosedQueue, currentNode);
				iterLimit = 0;
			}
			queue.clear();
		}
    ...
    {
//    	double valueComparator = 0;
//    	Node nodeWithMaxValue = new Node(null, null, null);
//    	if(nodes.size() > 0){
//    		for (int i = 0; i < nodes.size(); i++) 
//    		{
//    			if(nodes.get(i).value > valueComparator)
//    			{
//    				nodeWithMaxValue = nodes.get(i);
//    			}
//    		}
//    	}
