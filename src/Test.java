...
public class Test
{
    ...
    public static void main(String[] args)
    {
        ...
        String genetic = "controllers.genetic.Agent";
        String hill = "AgentHillClimber";
        String ideep = "notbot.tiago.iterative.deepening.Agent";
        ...
        games = new String[]{"zelda", "boulderdash" ,"butterflies", "chase", "frogs",
                "missilecommand", "portals", "sokoban", "survivezombies", "zelda"};
...
//            }
//            ArcadeMachine.runGames(game, levels, M, ideep, saveActions? actionFiles:null);
//        }
    }
}
