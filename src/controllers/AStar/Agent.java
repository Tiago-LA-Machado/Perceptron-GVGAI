...
//				System.out.println(newState.getGameScore());
//				System.out.println(newState.getBlockSize());
//				System.out.println(newState.getAvailableActions());
//				System.out.println(newState.getGameWinner());
//				Iterator<Event> it = newState.getEventsHistory().iterator();
//				while(it.hasNext())
//				{
//					Event e = it.next();
//					System.out.println("from avatar = " + e.fromAvatar);//true
//					System.out.println("position = " + e.position);//distance to the position
//					System.out.println("avatar position = " + newState.getAvatarPosition());
//					System.out.println("resources = " + newState.getAvatarResources().size());
//					System.out.println("action = " + newState.getAvatarLastAction().name());
//					System.out.println("score" + newState.getGameScore());
//					
//					//StateObservation so = new StateObservation(null);
//					
//				}
